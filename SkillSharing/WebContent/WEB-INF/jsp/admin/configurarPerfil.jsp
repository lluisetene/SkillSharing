...
<html lang="es-ES">
	...
	<t:paginaBasica title="Configurar perfil"/>
		...
		<body style = "background-color:eeeeee">
				...
				<input TYPE = "button" style="font-weight:bold; background-color:white; border: 2px solid; color:black; margin-left:35%;margin-top:5%; width:100px; height:35px" class = "btn" value = "Aceptar" data-toggle="modal" data-target="#myModal" onclick = "document.getElementById('username').disabled=false;"/>
				...
				<input type = "button" style="font-weight:bold; background-color:white; border: 2px solid; color:black; margin-left:35%;margin-top:5%; width:100px; height:35px" class = "btn" value = "Aceptar" data-toggle="modal" data-target="#myModal2" onclick = "document.getElementById('username').disabled=false;"/>
