    	...
    	<div class="panel-body" style="background-color:073763">
			<div class="col-lg-12" style="background-color:eeeeee; border-radius:10px 10px 10px 10px;">
            	<div class="table-responsive">
					<h1 style = "color:black; margin:0; padding-left:40px; padding-top:10px	">Eliminar Colaboración</h1>
		...
		<table>
							...
							<table>
								...
								<tr style = "height:100px">
						                ...
						                <td><form:input cssClass="form-control" style = "background-color:eeeeee;display:inline-block;color:black;width:100px;border:1px solid black" type="text" path="beginningDate" name="datepicker" id = "from"  size="10" readonly="true" disabled="true"/><form:errors path="beginningDate" cssClass="error" /></td>
						        
						          		<td style = "padding-left:210px;width:375px"><form:label path="endingDate">Fecha fin</form:label></td>
					               		<td><form:input cssClass="form-control" style = "background-color:eeeeee;display:inline-block;color:black;width:100px;border:1px solid black" type="text" path="endingDate" name="datepicker" id="to" size="10" readonly="true" disabled = "true"/><form:errors path="endingDate" cssClass="error" /><td>
	    	...
	    	<div class="modal-dialog">
		      	...
		      	<div class="modal-content">
		        	<div class="modal-header">
		          		...
		          		<h4 style = "color:black" class="modal-title">Eliminar Colaboracion</h4>
		        	</div>
		        	<div class="modal-body">
		          		<p><i>Seguro que desea Eliminar esta colaboracion?</i></p>
		        	</div>
