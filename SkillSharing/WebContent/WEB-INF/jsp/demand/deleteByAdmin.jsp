...
<html lang="es-ES">
	...
	<t:paginaBasica title="Eliminar Demanda"/>
		...
		<body style = "background-color:eeeeee">
				...
				<div class = "bordesRedondeados" style = "width:73%;margin-left:25%;margin-top:1%;padding:0.5%;background-color:073763; border:1px solid black; height:110%; margin-bottom:240px">
    				...
    				<div class = "bordesRedondeados panel-body" style="background-color:eeeeee; border:1px solid black; width:100%; height:100%; margin-left:0%; margin-right:0%; padding:1%; margin-bottom:1%">
    					...
    					<h1 style = "color:black;margin:0; padding-left:20px">Eliminar Demanda</h1>
				    	...
				    	<form:form method="post" style = "padding-top:10; padding-left:25" modelAttribute="demand">
							...
							<table>
					            ...
					            <tr style = "height:50px">
					                ...
					                <td><form:input cssClass="form-control" style = "color:black;width:675px;border:1px solid black" type = "text" maxlength = "100" path="name" disabled = "true" readonly="true"/><form:errors path="name" cssClass="error" /></td>
				            	...
				            	<table>
						            ...
						            <tr style = "height:100px">
						                ...
						                <td><form:input cssClass="form-control" style = "background-color:eeeeee;display:inline-block;color:black;width:100px;border:1px solid black" type="text" path="beginningDate" name="datepicker" id = "from" size="10" value="${offer.beginningDate }" disabled = "true" readonly="true"/><form:errors path="beginningDate" cssClass="error" /></td>
						        
						          		<td style = "padding-left:200px;width:400px"><form:label path="endingDate">Fecha fin</form:label></td>
					               		<td><form:input cssClass="form-control" style = "background-color:eeeeee;display:inline-block;color:black;width:100px;border:1px solid black" type="text" path="endingDate" name="datepicker" id = "to" size="10" value = "${offer.endingDate }" disabled = "true" readonly="true"/><form:errors path="endingDate" cssClass="error" /><td>
							    ...
							    <div class="modal-dialog">
							      ...
							      <div class="modal-content">
							        <div class="modal-header">
							          ...
							          <h4 style = "color:black" class="modal-title">Eliminar Demanda</h4>
							        </div>
