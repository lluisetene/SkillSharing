...
<t:paginaBasicaStudent/>
	...
	<div class="col-lg-8" style="background-color:073763; border-radius:10px 10px 10px 10px; margin-top:-350px">
    	<div class="panel-body" style="background-color:073763">
			<div class="col-lg-12" style="background-color:eeeeee; border-radius:10px 10px 10px 10px;">
            	<div class="table-responsive">
					<h1 style = "color:black; margin:0; padding-left:40px; padding-top:10px	">Modificar Demanda</h1>
			...
			<table>
	            ...
	            <tr>
	                <td>
	         			...
	         			<form:input style = "widt:337px; border:1px solid black; color:black" type = "text" maxlength = "30" path="idSkill" disabled="true" readonly="true" value = "${demand.idSkill.split('/')[1]}"/><form:errors path="idSkill" cssClass="error" />
					</td>
	            </tr>
		...
		<input style="font-weight:bold; background-color:white; border: 2px solid; color:black; margin-left:35%;margin-top:5%; width:100px; height:35px" class = "btn" value = "Aceptar" data-toggle="modal" data-target="#myModal"
        	onclick = "document.getElementById('idDemand').disabled=false, 
	    	...
	    	<div class="modal-dialog">
		      	...
		      	<div class="modal-content">
		        	<div class="modal-header">
		          		...
		          		<h4 style = "color:black" class="modal-title">Modificar Demanda</h4>
		        	</div>
		        	<div class="modal-body">
		          		<p><i>¿Seguro que desea Modificar los datos de esta demanda?</i></p>
		        	</div>
