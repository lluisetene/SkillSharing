...
<t:paginaBasica title="Oferta">
	...
	<body>
		...
		<div class = "panel-body bordesRedondeados" style="height:76.3%; padding-top:0px;background-color:eeeeee">
			...
			<div style = "padding-bottom:5px; display:inline-block;width:63.2%;background-color:eeeeee"><h1 style="padding-left:220px; color:black"><i><b>Ofertas Disponibles</b></i></h1></div>
		...
		<div class = "pre-scrollable panel-body" style = "max-height: 400px; height: 400px;border:2px solid black; background-color:597eaa">
			        ...
			        <c:forEach items="${offers}" var= "offer">
			      		...
			      		<div style = "padding-left:8px;border:2px solid black; background-color:white">
				             ...
				             <div class = "panel-body" style = "width:25%;display:inline-block; border: 2px solid black; background-color:white"><i class="glyphicon glyphicon-bookmark" style="color:black"></i><b style = "color:black"> ${offer.idSkill.split("/")[1]} </b></div>
			      			 ...
			      			 <div class="panel" style = "border-top: thick double black;background-color:white; padding: 10px 25px 10px 50px;margin:0; padding-right:25px">
								...
								<table style = "display:inline-block">
									...
									<tr>
										...
										<td><h6>Habilidad: ${offer.idSkill.split("/")[1]}</h6></td>
										<td><h6 style = "padding-left:15%">Nivel: ${offer.idSkill.split("/")[2]}</h6></td>
									
									</tr>
									<tr>
									
										<td><h6>Fecha de Inicio: ${offer.beginningDate}</h6></td>
										<td><h6 style = "padding-left:15%">Fecha de Fin: ${offer.endingDate}</h6></td>
