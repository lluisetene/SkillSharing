			...
			<table>
	            ...
	            <tr>
	                <td>
	         			...
	         			<form:input style = "widt:337px; border:1px solid black; color:black" type = "text" maxlength = "30" path="idSkill" disabled="true" readonly="true" value = "${offer.idSkill}"/><form:errors path="idSkill" cssClass="error" />
					</td>
	            </tr>
