...
<html lang="es-ES">
	...
	<t:paginaBasica title="Modificar Oferta"/>
		...
		<body style = "background-color:eeeeee">
				...
				<div class = "bordesRedondeados" style = "width:73%;margin-left:25%;margin-top:1%;padding:0.5%;background-color:073763; border:1px solid black; height:110%; margin-bottom:25px">
    				...
    				<div class = "bordesRedondeados panel-body" style="background-color:eeeeee; border:1px solid black; width:100%; height:100%; margin-left:0%; margin-right:0%; padding:1%; margin-bottom:1%">
    					...
    					<h1 style = "color:black;margin:0; padding-left:20px">Modificar Oferta</h1>
				    	...
				    	<form:form method="post" style = "padding-top:10; padding-left:25" modelAttribute="offer">
							...
							<table>
					            ...
					            <tr style = "height:50px">
					                ...
					                <td><form:input cssClass="form-control" style = "background-color:eeeeee;color:black;width:150px;border:1px solid black" type = "text" maxlength = "9" path="nid" disabled = "true" readonly = "true"/><form:errors path="nid" cssClass="error"/></td>
							    ...
							    <div class="modal-dialog">
							      ...
							      <div class="modal-content">
							        ...
							        <div class="modal-body">
							          <p><i>¿Seguro que desea Modificar esta Oferta?</i></p>
							        </div>
