...
<html lang="es-ES">
	...
	<t:paginaBasica title="Modificar Habilidad"/>
		...
		<body style = "background-color:eeeeee">
				...
				<div class = "bordesRedondeados" style = "width:73%;margin-left:25%;margin-top:1%;padding:0.5%;background-color:073763; border:1px solid black; height:85%; margin-bottom:110px">
    				...
    				<div class = "bordesRedondeados panel-body" style="background-color:eeeeee; border:1px solid black; width:100%; height:100%; margin-left:0%; margin-right:0%; padding:1%; margin-bottom:1%">
    					...
    					<h1 style = "color:black;margin:0; padding-left:20px">Modificar Habilidad</h1>
						...
						<table>
				            ...
				            <tr style = "height:50px">
				                ...
				                <td><form:label path="description" >Descripción <h6 style = "display:inline-block">(300 Caracteres)</h6></form:label></td>
							    ...
							    <div class="modal-dialog">
							      ...
							      <div class="modal-content">
							        <div class="modal-header">
							          ...
							          <h4 style = "color:black" class="modal-title">Modificar Habilidad</h4>
							        </div>
							        <div class="modal-body">
							          <p><i>¿Seguro que desea Modificar esta habilidad?</i></p>
							        </div>
